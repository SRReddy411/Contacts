...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
// This   CNContactStore represents contacts database on the device.
     var store = CNContactStore()
    
    // This is authorization status and ask the user to grant access in case the status is not determined or denied
